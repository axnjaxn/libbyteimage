...
void byteimage::rgb2hsl(ByteImage::BYTE r, ByteImage::BYTE g, ByteImage::BYTE b, float &h, float &s, float &l) {
  return byteimage::rgb2hsl((Byte)r, (Byte)g, (Byte)b, h, s, l);
}

void byteimage::hsl2rgb(float h, float s, float l, ByteImage::BYTE &r, ByteImage::BYTE &g, ByteImage::BYTE &b) {
  return byteimage::hsl2rgb(h, s, l, (Byte&)r, (Byte&)g, (Byte&)b);
}
